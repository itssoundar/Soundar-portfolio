  ...
  return (
    <div className="w-full bg-[#FAFAFA] py-16 lg:py-24 border-t border-gray-100 mt-20">
      <div className="max-w-[1000px] mx-auto px-4 md:px-8">
        <h3 className="text-[22px] md:text-[28px] font-bold -900 mb-8 md:mb-12 font-sans">Other Projects</h3>
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          {otherProjects.map(project => (
            ...
            >
                ...
                <h4 className="text-[16px] md:text-[18px] md:text-[20px] font-bold text-gray-900 mb-2 font-sans">{project.title}</h4>
                <p className="text-[16px] md:text-[18px] -500 leading-relaxed font-medium">{project.description}</p>
            </Link>
          ))}
        </div>
      </div>
