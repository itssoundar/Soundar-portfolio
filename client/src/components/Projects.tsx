            ...
            <div className="relative w-full flex-1 flex justify-center items-center mt-4">
              ...
              <div className="absolute inset-0 flex items-center justify-center z-20 pointer-events-none mt-0 sm:mt-0">
                ...
                >
                  ...
                  <div className="absolute top-[120px] sm:top-10 -left-48 sm:left-40 md:left-40 lg:left-48 flex flex-col gap-2.5 sm:gap-4 z-20 scale-[0.6] sm:scale-90 lg:scale-100 origin-left">
                  ...
                  <div className="relative z-10 mt-10 md:mt-12 flex-1 flex flex-col justify-center max-h-[350px] sm:max-h-full w-full pointer-events-none">
                    <img 
                      src="/Soundar1.png" 
                      alt="Process Preview"
                      className="h-[350px] sm:h-[280px] md:h-[380px] w-auto object-contain object-bottom mx-auto transform -translate-y-[64px] scale-[1.15] sm:scale-100 sm:-translate-y-12 md:-translate-y-12 lg:-translate-y-16"
                    />
