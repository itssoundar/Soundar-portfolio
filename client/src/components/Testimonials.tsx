              ...
              {props.testimonials.map(({ text, image, name, role }, i) => (
                ...
                >
                  <blockquote className="m-0 p-0 h-full flex flex-col relative z-10 gap-6 md:gap-8">
                    <p className="text-[16px] md:text-[18px] group-hover:leading-[1.6] m-0 transition-colors duration-300">
                      {text}
                    </p>
                    <footer className="flex items-center gap-4 transition-colors duration-300">
                      ...
                      <div className="flex flex-col">
                        <cite className="font-semibold text-[#111] text-[16px] md:text-[18px] not-italic tracking-tight transition-colors duration-300">
                          {name}
                        </cite>
                        <span className="text-[#666] text-[16px] md:text-[18px] tracking-wide mt-0.5 transition-colors duration-300">
                          {role}
                        </span>
                      </div>
                    </footer>
      ...
      >
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center lg:items-start justify-between w-full">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left lg:sticky lg:top-32 max-w-xl shrink-0 lg:pt-12">
            <h2 id="testimonials-heading" className="text-[32px] md:text-[40px] font-medium tracking-[-0.02em] leading-[1.1] font-sans">
              See what <span className="text-[#111]">others</span><br className="hidden lg:block" />
              say about me
            </h2>
            <p className="text-[16px] md:text-[18px] mt-6 leading-[1.6] max-w-md tracking-wide font-sans">
              I have helped many businesses make a killer design for their product. Wanna be the next?
            </p>
            <a href="#contact" className="mt-10 inline-flex items-center justify-center gap-2 rounded-full bg-[#B2F042] px-8 py-4 text-[16px] md:text-[18px] font-semibold text-black transition-all hover:scale-105 hover:bg-[#a0dc3b] shadow-sm">
              Contact
