      ...
      <div className="w-full bg-white py-16 lg:py-24 relative z-10">
        ...
        <div className="mb-16">
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-xl p-6 mb-8">
            <p className="text-[14px] md:text-base text-gray-900 font-medium mb-4">Multiple modules had:</p>
        ...
        <div className="mb-16">
          ...
          <p className="text-[14px] md:text-base text-gray-600 leading-relaxed mb-4">I initiated with:</p>
        ...
        <div className="bg-[#1b1c3c] text-white rounded-xl p-8 md:p-10 mb-16 shadow-lg relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="border-l-4 border-indigo-400 pl-4 py-1">
              ...
              <p className="text-[14px] md:text-base text-indigo-200 font-medium mt-2">The design language was not.</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <p className="text-[14px] md:text-base text-gray-600 mb-6">Each module evolved independently.</p>
          <p className="text-[14px] md:text-base text-gray-900 font-medium mb-4">Examples:</p>
          ...
          <div className="mt-8">
            <p className="text-[14px] md:text-base font-semibold text-gray-900 mb-2">Impact:</p>
        ...
        <div className="mb-16">
          ...
          <p className="text-[14px] md:text-base text-gray-600 mb-6">Without a structured component system:</p>
          <ul className="list-disc pl-5 space-y-2 text-gray-600 mb-8">
        ...
        <div className="mb-16 border-t border-gray-200 pt-16">
          ...
          <div className="grid md:grid-cols-12 gap-8 mb-10">
            ...
            <div className="md:col-span-9 space-y-6">
              <div>
                <p className="text-[14px] md:text-base font-bold text-gray-900 mb-1">• Improve Product Consistency Across CRM Modules</p>
                <p className="text-gray-600 text-[14px] md:text-sm ml-4">Ensure a unified design language and interaction model across all CRM surfaces.</p>
              </div>
              <div>
                <p className="text-[14px] md:text-base font-bold text-gray-900 mb-1">• Reduce Design-to-Development Cycle Time</p>
                <p className="text-gray-600 text-[14px] md:text-sm ml-4">Streamline the handoff process and reusable components to accelerate delivery.</p>
              </div>
              <div>
                <p className="text-[14px] md:text-base font-bold text-gray-900 mb-1">• Improve Platform Stickiness & Retention</p>
                <p className="text-gray-600 text-[14px] md:text-sm ml-4">Introduce standardized components and patterns to reduce inconsistencies and cognitive load.</p>
              </div>
              <div>
                <p className="text-[14px] md:text-base font-bold text-gray-900 mb-1">• Enable Faster Feature Experimentation</p>
                <p className="text-gray-600 text-[14px] md:text-sm ml-4">Create a scalable system that allows teams to test and iterate on new features quickly.</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-12 gap-8 pt-8 border-t border-gray-100">
            ...
            <div className="md:col-span-9 space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-600 text-[14px] md:text-sm ml-4">Design structured flows that reduce friction and make task completion easier.</p>
              </div>
              <div>
                <p className="text-[14px] md:text-base font-bold text-gray-900 mb-1">• Reduced Cognitive Switching Across Modules</p>
                <p className="text-gray-600 text-[14px] md:text-sm ml-4">Maintain similar layouts and behaviors across CRM areas to minimize mental load.</p>
              </div>
              <div>
                <p className="text-[14px] md:text-base font-bold text-gray-900 mb-1">• Faster Onboarding for New Recruiters</p>
                <p className="text-gray-600 text-[14px] md:text-sm ml-4">Simplify the interface so new users can quickly learn and start using the platform.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16 pt-12 border-t border-gray-200">
          ...
          <p className="text-[14px] md:text-base text-gray-600 font-medium mb-4">I redefined the component hierarchy:</p>
          <ul className="list-disc pl-5 space-y-2 text-gray-600 mb-6">
        ...
        <div className="mb-16 border-t border-gray-200 pt-16">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            <div className="bg-[#1b1c3c] text-white p-6 rounded-xl">
              ...
              <p className="font-semibold text-[14px] md:text-lg mb-4 leading-tight">Faster design-to-development turnaround</p>
              <p className="text-white/80 text-[14px] md:text-sm">Improved design system consistency helped teams ship features faster and reduced handoff friction between design and engineering.</p>
            </div>
            
            <div className="bg-[#1b1c3c] text-white p-6 rounded-xl">
              <h4 className="text-2xl font-bold mb-2">28%</h4>
              <p className="font-semibold text-[14px] md:text-lg mb-4 leading-tight">Reduction in UI inconsistency bugs</p>
              <p className="text-white/80 text-[14px] md:text-sm">Standardized components and interaction patterns reduced UI-related issues across CRM modules.</p>
            </div>
            
            <div className="bg-[#1b1c3c] text-white p-6 rounded-xl">
              <h4 className="text-2xl font-bold mb-2">40%+</h4>
              <p className="font-semibold text-[14px] md:text-lg mb-4 leading-tight">Reduction in duplicated design work</p>
              <p className="text-white/80 text-[14px] md:text-sm">Shared design patterns eliminated redundant work across teams and improved design efficiency.</p>
            </div>
          </div>
