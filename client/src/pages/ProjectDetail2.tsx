...
export default function ProjectDetail2({ hideHeader = false }: { hideHeader?: boolean }) {
  useEffect(() => {
    if (!hideHeader) {
      window.scrollTo(0, 0);
    }
      ...
      <div className={`w-full bg-gray-50 ${hideHeader ? 'pt-8' : 'pt-16'} pb-16 lg:pb-24 border-b border-gray-200 relative z-20`}>
        <div className="max-w-[1000px] mx-auto px-4 md:px-8">
          <div className="w-full">
            {/* Project Header */}
            <div className="mb-0">
              {!hideHeader ? (<h2 className="text-[32px] md:text-[40px] font-bold mb-6 leading-[1.3] tracking-tight font-sans">Building a Scalable Design System for a Growing HR Platform</h2>) : (<h2 className="text-[22px] font-bold mb-4 mt-2">Context</h2>)}
      ...
      <div className="w-full bg-white pt-16 lg:pt-24 pb-0 relative z-10">
        ...
        <div className="mb-16">
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-xl p-6 mb-8">
            <p className="text-[16px] md:text-[18px] -900 font-medium mb-4">Multiple modules had:</p>
        ...
        <div className="mb-16">
          ...
          <p className="text-[16px] md:text-[18px] -600 leading-relaxed mb-4">I initiated with:</p>
        ...
        <div className="bg-[#1b1c3c] text-white rounded-xl p-8 md:p-10 mb-16 shadow-lg relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="border-l-4 border-indigo-400 pl-4 py-1">
              <p className="text-[16px] md:text-[18px] -200 font-medium">The product was scaling.</p>
              <p className="text-[16px] md:text-[18px] -200 font-medium mt-2">The design language was not.</p>
            </div>
          </div>
        </div>
        ...
        {/* Problem 1 Section */}
        <div className="mb-16">
          <h3 className="text-[22px] md:text-[28px] font-bold -900 mb-6">Problem 1: Inconsistent Patterns Across Modules</h3>
          <p className="text-[16px] md:text-[18px] -600 mb-6">Each module evolved independently.</p>
          <p className="text-[16px] md:text-[18px] -900 font-medium mb-4">Examples:</p>
          ...
          <div className="mt-8">
            <p className="text-[16px] md:text-[18px] font-semibold -900 mb-2">Impact:</p>
        ...
        {/* Problem 2 Section */}
        <div className="mb-16">
          <h3 className="text-[22px] md:text-[28px] font-bold -900 mb-6">Problem 2: High UI Debt & Low Reusability</h3>
          <p className="text-[16px] md:text-[18px] -600 mb-6">Without a structured component system:</p>
          <ul className="list-disc pl-5 space-y-2 text-gray-600 mb-8">
        ...
        <div className="mb-16 border-t border-gray-200 pt-16">
          ...
          <div className="grid md:grid-cols-12 gap-8 mb-10">
            ...
            <div className="md:col-span-9 space-y-6">
              <div>
                <p className="text-[16px] md:text-[18px] font-bold -900 mb-1">• Improve Product Consistency Across CRM Modules</p>
                <p className="text-[16px] md:text-[18px] -600 ml-4">Ensure a unified design language and interaction model across all CRM surfaces.</p>
              </div>
              <div>
                <p className="text-[16px] md:text-[18px] font-bold -900 mb-1">• Reduce Design-to-Development Cycle Time</p>
                <p className="text-[16px] md:text-[18px] -600 ml-4">Streamline the handoff process and reusable components to accelerate delivery.</p>
              </div>
              <div>
                <p className="text-[16px] md:text-[18px] font-bold -900 mb-1">• Improve Platform Stickiness & Retention</p>
                <p className="text-[16px] md:text-[18px] -600 ml-4">Introduce standardized components and patterns to reduce inconsistencies and cognitive load.</p>
              </div>
              <div>
                <p className="text-[16px] md:text-[18px] font-bold -900 mb-1">• Enable Faster Feature Experimentation</p>
                <p className="text-[16px] md:text-[18px] -600 ml-4">Create a scalable system that allows teams to test and iterate on new features quickly.</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-12 gap-8 pt-8 border-t border-gray-100">
            ...
            <div className="md:col-span-9 space-y-6">
              <div>
                <p className="text-[16px] md:text-[18px] font-bold -900 mb-1">• Consistent Interaction Patterns</p>
                <p className="text-[16px] md:text-[18px] -600 ml-4">Provide familiar UI behaviors so users can navigate the system with confidence.</p>
              </div>
              <div>
                <p className="text-[16px] md:text-[18px] font-bold -900 mb-1">• Predictable Workflows</p>
                <p className="text-[16px] md:text-[18px] -600 ml-4">Design structured flows that reduce friction and make task completion easier.</p>
              </div>
              <div>
                <p className="text-[16px] md:text-[18px] font-bold -900 mb-1">• Reduced Cognitive Switching Across Modules</p>
                <p className="text-[16px] md:text-[18px] -600 ml-4">Maintain similar layouts and behaviors across CRM areas to minimize mental load.</p>
              </div>
              <div>
                <p className="text-[16px] md:text-[18px] font-bold -900 mb-1">• Faster Onboarding for New Recruiters</p>
                <p className="text-[16px] md:text-[18px] -600 ml-4">Simplify the interface so new users can quickly learn and start using the platform.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16 pt-12 border-t border-gray-200">
          ...
          <p className="text-[16px] md:text-[18px] -600 font-medium mb-4">I redefined the component hierarchy:</p>
          <ul className="list-disc pl-5 space-y-2 text-gray-600 mb-6">
        ...
        {/* Solution 2 Section */}
        <div className="mb-16">
          <h3 className="text-[22px] md:text-[28px] font-bold -900 mb-8">Solution 2: Reusable CRM Component Library</h3>
        ...
        {/* Solution 3 Section */}
        <div className="mb-16">
          <h3 className="text-[22px] md:text-[28px] font-bold -900 mb-8">Solution 3: Interaction & Layout Standardization</h3>
        ...
        <div className="mb-16 border-t border-gray-200 pt-16">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            <div className="bg-[#1b1c3c] text-white p-6 rounded-xl">
              ...
              <p className="text-[16px] md:text-[18px] font-semibold mb-4 leading-tight">Faster design-to-development turnaround</p>
              <p className="text-[16px] md:text-[18px] /80">Improved design system consistency helped teams ship features faster and reduced handoff friction between design and engineering.</p>
            </div>
            
            <div className="bg-[#1b1c3c] text-white p-6 rounded-xl">
              <h4 className="text-2xl font-bold mb-2">28%</h4>
              <p className="text-[16px] md:text-[18px] font-semibold mb-4 leading-tight">Reduction in UI inconsistency bugs</p>
              <p className="text-[16px] md:text-[18px] /80">Standardized components and interaction patterns reduced UI-related issues across CRM modules.</p>
            </div>
            
            <div className="bg-[#1b1c3c] text-white p-6 rounded-xl">
              <h4 className="text-2xl font-bold mb-2">40%+</h4>
              <p className="text-[16px] md:text-[18px] font-semibold mb-4 leading-tight">Reduction in duplicated design work</p>
              <p className="text-[16px] md:text-[18px] /80">Shared design patterns eliminated redundant work across teams and improved design efficiency.</p>
            </div>
          </div>
