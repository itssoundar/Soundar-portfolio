...
// Replace the entire renderCardContent to be a clean 'a' tag that acts like a button so iOS Safari registers taps perfectly
content = content.replace(
  ...
  `const renderCardContent = (project: typeof projects[0], isFirst: boolean = false) => (
    <a
      ...
      className="block w-full bg-white rounded-[28px] p-[16px] md:p-[32px] shadow-[0_4px_24px_rgba(0,0,0,0.04)] border border-[#eaeaea] group transition-all duration-300 hover:shadow-[0_8px_32px_rgba(0,0,0,0.08)] relative z-[60] cursor-pointer" style={{ touchAction: "manipulation", WebkitTapHighlightColor: "transparent" }}>
