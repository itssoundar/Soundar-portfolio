...
files.forEach(file => {
  ...
  // In Next.js to Wouter migrations, sometimes we need to make sure the child is standard HTML
  // if it's already a component maybe it's fine, but let's change <a to <span just for any descendant inside <Link>
